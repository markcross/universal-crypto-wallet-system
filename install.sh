...
echo "$choice is now installed and executable via your Accessories menu" >> ARK.txt
echo
...
echo "USAGE byteball" > byteball.txt
echo
...
echo "USAGE $choice" > bcc-electrum.txt
...
echo "USAGE $choice" > BTC-electrum.txt
...
echo "USAGE $choice" > MyEtherWallet.txt
